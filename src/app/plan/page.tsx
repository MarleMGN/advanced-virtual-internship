              ...
              <div className="accordion__card">
                ...
                >
                  ...
                  <svg
                    ...
                    strokeWidth="0"
                    viewBox="0 0 16 16"
                    className={`accordion__icon ${openAccordion === 0 ? "accordion__icon--rotate" : ""}`}
                    height="1em"
                    width="1em"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                ...
                <div
                  className={`collapse ${openAccordion === 0 ? "show" : ""}`}
                  style={{ maxHeight: openAccordion === 0 ? "100px" : "0px" }}
                >
              ...
              <div className="accordion__card">
                ...
                >
                  ...
                  <svg
                    ...
                    strokeWidth="0"
                    viewBox="0 0 16 16"
                    className={`accordion__icon ${openAccordion === 1 ? "accordion__icon--rotate" : ""}`}
                    height="1em"
                    width="1em"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                ...
                <div
                  className={`collapse ${openAccordion === 1 ? "show" : ""}`}
                  style={{ maxHeight: openAccordion === 1 ? "100px" : "0px" }}
                >
                  <div className="accordion__body">
              ...
              <div className="accordion__card">
                ...
                >
                  ...
                  <svg
                    ...
                    strokeWidth="0"
                    viewBox="0 0 16 16"
                    className={`accordion__icon ${openAccordion === 2 ? "accordion__icon--rotate" : ""}`}
                    height="1em"
                    width="1em"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                ...
                <div
                  className={`collapse ${openAccordion === 2 ? "show" : ""}`}
                  style={{ maxHeight: openAccordion === 2 ? "100px" : "0px" }}
                >
                  <div className="accordion__body">
              ...
              <div className="accordion__card">
                ...
                >
                  ...
                  <svg
                    ...
                    strokeWidth="0"
                    viewBox="0 0 16 16"
                    className={`accordion__icon ${openAccordion === 3 ? "accordion__icon--rotate" : ""}`}
                    height="1em"
                    width="1em"
                    xmlns="http://www.w3.org/2000/svg"
                  >
                ...
                <div
                  className={`collapse ${openAccordion === 3 ? "show" : ""}`}
                  style={{ maxHeight: openAccordion === 3 ? "100px" : "0px" }}
                >
                  <div className="accordion__body">
