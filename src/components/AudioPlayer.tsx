    ...
    <div className="audio__wrapper">
      ...
      <div className="audio__progress--wrapper">
        ...
        <input
          ...
          style={
            {
              background: `linear-gradient(to right, rgb(43, 217, 124) ${(currentTime / (duration || 1)) * 100}%, rgb(109, 120, 125) ${(currentTime / (duration || 1)) * 100}%)`,
              "--range-progress": `${(currentTime / (duration || 1)) * 100}%`,
